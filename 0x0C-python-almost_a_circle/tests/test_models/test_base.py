...
class TestBase(unittest.TestCase):
    ...
    def test_base_to_json_string_empty(self):
        """Test if to_json_string returns an empty list
    ...
    def test_base_to_json_string(self):
        ...
        b8 = Base(10)
        b9 = Base(20)
        result = Base.to_json_string([b8.to_dictionary(), b9.to_dictionary()])
        expected = '[{"id": 10}, {"id": 20}]'
        self.assertEqual(result, expected)

    def test_base_from_json_string_empty(self):
        """Test if from_json_string returns an empty list for an empty
        JSON string"""
    ...
    def test_base_from_json_string(self):
        """Test if from_json_string returns the correct list representation"""
    ...
    def test_base_create(self):
        """Test if create returns an instance with attributes set
        from dictionary"""
    ...
    def test_base_draw(self):
        """Test if draw method opens a window and draws all the Rectangles
        and Squares"""
